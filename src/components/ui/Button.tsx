...
const variantClasses: Record<Variant, string> = {
  primary: "bg-customPurple text-foreground hover:bg-customPurple/30 w-[160px] font-[600]",
  ...
  outline: "bg-customPurple text-foreground hover:bg-customPurple/30 font-[600] w-[150px] py-[8px] px-[12px]",
